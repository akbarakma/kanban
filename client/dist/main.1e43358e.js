  ...
  methods: {
    ...
    loginUser: function loginUser() {
      ...
      axios_1.default({
        ...
        var $977153 = exports.default || module.exports;
      
      if (typeof $977153 === 'function') {
        $977153 = $977153.options;
      }
    
        /* template */
        Object.assign($977153, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$977153', $977153);
          } else {
            api.reload('$977153', $977153);
          }
        }
...
},{"vue":"node_modules/vue/dist/vue.runtime.esm.js","axios":"node_modules/axios/index.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js"}],"src/components/register.vue":[function(require,module,exports) {
"use strict";
...
exports.default = vue_1.default.extend({
  ...
  methods: {
    ...
    registerUser: function registerUser() {
      ...
      if (this.register_password !== this.register_password_confirm) {
        ...
        var $3bd848 = exports.default || module.exports;
      
      if (typeof $3bd848 === 'function') {
        $3bd848 = $3bd848.options;
      }
    
        /* template */
        Object.assign($3bd848, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", [
    ...
    _c("div", { staticClass: "container" }, [
      _c("div", { staticClass: "row justify-content-center" }, [
        _c("div", { staticClass: "card p-5" }, [
          _c("h1", [_vm._v("Register Your Account")]),
          _vm._v(" "),
          _c(
            "form",
            {
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$3bd848', $3bd848);
          } else {
            api.reload('$3bd848', $3bd848);
          }
        }
...
},{"vue":"node_modules/vue/dist/vue.runtime.esm.js","sweetalert2":"node_modules/sweetalert2/dist/sweetalert2.all.js","axios":"node_modules/axios/index.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js"}],"../../../../../../usr/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
exports.default = _default;
        var $ab9f5c = exports.default || module.exports;
      
      if (typeof $ab9f5c === 'function') {
        $ab9f5c = $ab9f5c.options;
      }
    
        /* template */
        Object.assign($ab9f5c, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
            ...
            [
              ...
              _c("div", { staticClass: "form-group" }, [
                ...
                _c(
                  "select",
                  {
                    ...
                    on: {
                      change: function($event) {
                        ...
                        _vm.task_category = $event.target.multiple
                          ? $$selectedVal
                          : $$selectedVal[0]
                      }
                    }
                  ...
                  [
                    _c("option", { attrs: { value: "Back-Log" } }, [
                      _vm._v("Back-Log")
                    ]),
                    _vm._v(" "),
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$ab9f5c', $ab9f5c);
          } else {
            api.reload('$ab9f5c', $ab9f5c);
          }
        }
...
},{"axios":"node_modules/axios/index.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/editTask.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  created: function created() {
    ...
    (0, _axios.default)({
      method: 'GET',
      url: base_url + "/tasks/".concat(this.editId),
      headers: {
        token: localStorage.getItem('token')
      }
    }).then(function (_ref) {
      var data = _ref.data;
      _this.edit_title = data.title;
      _this.edit_description = data.description;
      _this.edit_category = data.category;
    }).catch(function (err) {
      _this.$emit('showError', err);
    });
  },
  methods: {
    editData: function editData() {
      ...
      (0, _axios.default)({
        ...
        _this2.$emit('changePage', 'main');
      }).catch(function (err) {
        _this2.$emit('showError', err);
      });
    },
    mainPage: function mainPage() {
      this.$emit('changePage', 'main');
...
exports.default = _default;
        var $15fcd6 = exports.default || module.exports;
      
      if (typeof $15fcd6 === 'function') {
        $15fcd6 = $15fcd6.options;
      }
    
        /* template */
        Object.assign($15fcd6, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
            ...
            [
              ...
              _c("div", { staticClass: "form-group" }, [
                ...
                _c("input", {
                  ...
                  staticClass: "form-control",
                  attrs: { type: "text" },
                  domProps: { value: _vm.edit_description },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                      }
                      _vm.edit_description = $event.target.value
                    }
                  }
                })
              ]),
                  ...
                  "select",
                  {
                    ...
                    on: {
                      change: function($event) {
                        ...
                        _vm.edit_category = $event.target.multiple
                          ? $$selectedVal
                          : $$selectedVal[0]
                      }
                    }
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$15fcd6', $15fcd6);
          } else {
            api.reload('$15fcd6', $15fcd6);
          }
        }
...
var createTask_vue_1 = __importDefault(require("./components/createTask.vue"));

var editTask_vue_1 = __importDefault(require("./components/editTask.vue"));
...
exports.default = vue_1.default.extend({
  components: {
    ...
    createTask: createTask_vue_1.default,
  ...
  methods: {
    ...
    showError: function showError(err) {
      ...
      sweetalert2_1.default.fire({
        ...
        var $2902bb = exports.default || module.exports;
      
      if (typeof $2902bb === 'function') {
        $2902bb = $2902bb.options;
      }
    
        /* template */
        Object.assign($2902bb, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      ...
      _vm.page === "register"
        ? _c("register", {
            on: { changePage: _vm.changePage, showError: _vm.showError }
          })
        : _vm._e(),
      _vm._v(" "),
      _vm.page === "main"
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$2902bb', $2902bb);
          } else {
            api.reload('$2902bb', $2902bb);
          }
        }
...
},{"vue":"node_modules/vue/dist/vue.runtime.esm.js","sweetalert2":"node_modules/sweetalert2/dist/sweetalert2.all.js","./components/login.vue":"src/components/login.vue","./components/register.vue":"src/components/register.vue","./components/main.vue":"src/components/main.vue","./components/createTask.vue":"src/components/createTask.vue","./components/editTask.vue":"src/components/editTask.vue","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js"}],"src/main.js":[function(require,module,exports) {
"use strict";
